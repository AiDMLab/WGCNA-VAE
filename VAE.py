...
# Read input file
input_filename = "C:\\Users\\dell\\Downloads\\geo\\txt\\classification.xlsx"
output_filename = "result.csv"
input_df = pd.read_excel(input_filename)
input_df=input_df.iloc[:,1:(len(input_df.columns)-1)]
print("INPUT FILE...")
...
plt.savefig('C:\\Users\\dell\\Downloads\\DeepProfile-master\\stationClocks1',dpi=400)
plt.show()
...
fig = plt.gcf()
fig.set_size_inches(14.5, 8.5)
plt.savefig('C:\\Users\\dell\\Downloads\\vae\\stationClocks',dpi=400)
plt.show()
